...
function BookEvent(props) {
    ...
    const [confirmSeatClasses, setConfirmSeatsClasses] = useState("btn btn-ai btn-lg position-absolute top-75 start-50 translate-middle");
    ...
    if (gotMovieDetails === false) {
        ...
        axios.get("/movies/" + movieId)
            ...
            .catch((error) => {
                ...
                setConfirmSeatsClasses(confirmSeatClasses + " disabled");
            });
    }
    ...
    const seatClicked = (e) => {
        ...
        if (e.currentTarget.className.includes("active")) {
            ...
            debugger;
            let seat = {
                row: e.currentTarget.id.split("-")[0],
                seat: e.currentTarget.id.split("-")[1]
            }
    ...
    const returnSeats = (rowNumber, numOfSeats) => {
        ...
        for (var i = 1; i <= numOfSeats; i++) {
            ...
            if (movieDetails.includes(seat)) {
                seats.push(<div key={rowNumber + "-" + i} id={rowNumber + "-" + i} className="seat"></div>)
    ...
    return (
        <div id="booking" className="container-fluid bg-light position-relative">
            <div className="">
                ...
                {gotMovieDetails ? returnRows(5, 4) : null}
            </div>
            <button className={confirmSeatClasses} onClick={confirmSeat}>Confirm Seats</button>
